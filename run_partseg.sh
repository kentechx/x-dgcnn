...
# full dataset
python main_partseg.py --exp_name=${exp_name} --model=${model} --dropout=${dropout}
# eval full dataset
...
do
    # train
    python main_partseg.py --exp_name=${exp_name}_${choice} --class_choice=${choice} --model=${model} --dropout=${dropout}
    # eval
